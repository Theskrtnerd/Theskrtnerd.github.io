  ...
  return (
    <article className="px-6 max-w-[760px] mx-auto pt-16 md:pt-20 pb-24">
      ...
      <header className="animate-fade-up delay-2 mb-12">
        ...
        <h1 className="mt-4 font-sans font-medium text-4xl md:text-6xl tracking-[-0.03em] leading-[1.02]">
          {post.title}
        </h1>

        {post.description && (
          <p className="mt-5 text-lg text-muted italic leading-snug">
            {post.description}
          </p>
        )}
      </header>
        ...
        <div>
          {prev && (
            ...
            >
              ...
              <p className="font-sans text-lg mt-2 underline decoration-transparent decoration-1 underline-offset-[6px] group-hover:decoration-foreground/40 transition-colors lowercase">
                {prev.title}
              </p>
            </Link>
          )}
